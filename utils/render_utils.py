...
def convert_SH(
    ...
    dir_pp = torch.nan_to_num(dir_pp)
    dir_pp_normalized = dir_pp / dir_pp.norm(dim=1, keepdim=True).clamp_min(1e-6)
    dir_pp_normalized = torch.nan_to_num(dir_pp_normalized)
